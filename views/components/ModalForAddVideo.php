...
<form class="formForAdd"enctype='multipart/form-data'>
  <div class="mb-3">
    <label for="exampleInputTitle" class="form-label">Название</label>
    <input type="email" class="form-control" id="exampleInputTitle" aria-describedby="titleHelp">
  ...
  <div class="mb-3">
    ...
    <input type="file" class="form-control" id="exampleInputVideo">
  </div>
  <div class="mb-3">
